...
while True:
    menu = int(input("would you like to login or exit the app, \nEnter 1 to login and 2 to close the app: \n"))
    if menu == 1:
...
while menu == 1:
    ...
    main()
    print(
        "welcome to the system, please create a new account, check account details, carry out banking transactions or log out.")
    ...
    class Banking:
        ...
        def deposit(self):
            ...
            self.balance += amount
            return f"this is the amount deposited {amount} "
    ...
    while True:
        ...
        if option == "Create a new bank account":
            ...
            selected_option = (input("enter 1 for deposit or 2 for withdrawal \n"))
